import HautevilleHouse.ContinuousCohomologyLieGroupsFoundationCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "continuous cohomology of Lie groups: admissible class closure via bridge and gate",
